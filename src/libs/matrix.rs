//! A generic [symmetric matrix](https://en.wikipedia.org/wiki/Symmetric_matrix) to be used for
//! clustering.
    ...
    T: Default + Copy,
{
    ...
    pub fn new(size: usize) -> Self {
        let data = vec![T::default(); (size * (size + 1)) / 2];
        SymmetricMatrix { size, data }
    }
    ...
    pub fn get(&self, row: usize, col: usize) -> T {
        self.data[self.index_for(row, col)]
    }
